export const materiasJogos = [
    {
      ...
      conteudo: `
      A PS Plus vai adicionar em maio novos games para assinantes dos planos Essencial, Extra e Deluxe, que poderão ser jogados em PlayStation 4 (PS4) e PlayStation 5 (PS5). Entre os destaques estão os títulos Grid Legends, Chivalry 2 e Descenders, que poderão ser baixados a partir da primeira terça-feira do mês (2) e ficarão disponíveis até 6 de junho.
    ...
    },
    {
      ...
      conteudo: `
      Honkai: Star Rail é um novo jogo de RPG gratuito com batalhas em turnos criado pela produtora chinesa miHoYo, agora HoYoverse, conhecida pelo game de sucesso Genshin Impact. A história do game segue um personagem denominado "Trailblazer", um explorador espacial a bordo da espaçonave Astral Express que cuida de missões por todo o universo.

      Honkai: Star Rail está disponível para Android e iPhone (iOS), além de PC pelo site oficial da HoYoverse e na Epic Games Store. Futuramente, o jogo ganhará versões também para PlayStation 5 (PS5) e PlayStation 4 (PS4). Apesar de gratuito, o game conta com elementos "Gacha" que podem usar dinheiro real para obter novos personagens e armas.

      O mundo de Honkai: Star Rail mistura fantasia e ficção científica em um universo habitado por "Aeons", forças primordiais que vagam pelas estrelas redefinindo a realidade e espalhando suas crenças. Um dos Aeons que canaliza a força da "Destruição" espalha a discórdia por várias civilizações ao implantar um pedaço de seu poder, os Stellarons, para causar o caos. O jogador encarna um protagonista, masculino ou feminino, que é também o receptáculo de um Stellaron, mas que pretende usá-lo para ajudar pessoas em outros planetas.

      Após um ataque à estação espacial onde o jogo se inicia, jogadores partem a bordo da espaçonave Astral Express, que se assemelha a um trem. Os Aeons são capazes de viajar por todo o universo utilizando uma força primitiva única e, ao seguir seus rastros, os aventureiros são denominados "Trailblazers". O herói (ou heroína) será acompanhado por outros três personagens em combate e durante suas aventuras, além de poder interagir com o resto da equipe da Astral Express.

      Usuários podem se perguntar se o game tem ligação com outro título da HoYoverse de nome semelhante, Honkai Impact, que já teve 3 jogos anteriores. Tecnicamente, Honkai: Star Rail é conectado ao terceiro game, porém, se passa em um universo alternativo, de forma que não é necessário ter jogado o título anterior para entender a história.

      A jogabilidade básica de Honkai: Star Rail é de um RPG com batalhas em turnos tradicionais. Não há um mundo aberto como em Genshin Impact, mas cada novo planeta e estação espacial oferece uma grande área para explorar livremente, além de dungeons para desafiar. Espalhados por essas áreas estão também quebra-cabeças e baús, algo que deve ser bastante familiar para fãs de outros games da HoYoverse, que podem oferecer valiosas recompensas.

      Ao encontrar um inimigo, o usuário pode entrar em batalha imediatamente ou tentar atingir um golpe antecipado. Cada adversário possui pontos fracos que podem ser explorados nesses golpes antecipados para causar desvantagens para eles em combate.

      As lutas se desenvolvem com os quatro personagens que podem usar ataques comuns, habilidades chamadas de "Técnicas" e até finalizar inimigos com um golpe especial denominado "Perícia Suprema". Além das batalhas oferecidas pelos eventos da história, há também várias missões que apresentam conteúdo em formato de desafios que podem ser repetidos.

      Honkai: Star Rail é um game com mecânicas "Gacha", ou seja, o usuário pode invocar novos heróis para compor seu time, além de armas para eles. No entanto, nem todos os personagens têm o mesmo nível de poder e utilidade. Por isso eles são separados em "Tiers", níveis que vão desde os melhores SS e S até guerreiros medianos e razoáveis nos níveis A, B e C. Confira a lista atual de Tiers de personagens do game:
    ...
    },
    {
      ...
      Dessa forma, muitos títulos já podem ser apontados como confirmados para o ROG Ally. Entre eles, estão Death Stranding, Monster Hunter Rise, Hogwarts Legacy, Cyberpunk 2077, Call of Duty: Modern Warfare 2 2022, Battlefield 2042 , FIFA 23, Street Fighter 5, It Takes Two, Marvel’s Spider-Man: Miles Morales, League of Legends, Dota 2 e muitos outros.
      ...
      O produto terá um evento de lançamento global nodia 11 de maio, às 11h (horário de Brasília), quando serão revelados alguns detalhes de performance e preço do console. Ainda assim, vale lembrar que muitos dispositivos da marca gamer da Asus não vêm imediatamente ao Brasil, e a assessoria ainda não confirma a chegada do ROG Ally por aqui.
      `,
    ...
    },
    {
      ...
      conteudo: `
      Forza Horizon 5 é um jogo de corrida estilo "arcade", desenvolvido pela Playground Games e publicado pela Xbox Game Studios. Nele, são oferecidos uma série de veículos para que o jogador corra, realize provas e faça manobras. Inclusive, uma destas últimas é o drift, que, se usado de forma inteligente, pode facilitar corridas e reduzir o tempo de alguns circuitos. No entanto, uma boa execução é difícil, e vai depender do carro, da marcha, do terreno e da prática do jogador.

      Pensando nisso, o TechTudo elaborou um passo a passo para saber como fazer drift no Forza Horizon 5. Vale lembrar que o título está disponível para Xbox Series X, Xbox Series S, Xbox One e PC (via Steam). Veja o tutorial e as dicas a seguir.

      O drift é normalmente feito em curvas, mas pode ser feito em retas, se existir espaço. Isso porque, durante a manobra, o carro derrapa sem perder muita aceleração, o que pode lançá-lo com mais força adiante e fazer você não conseguir poupar tempo nas corridas. Assim, para realizá-lo, o ideal é usar um controle. Veja, a seguir, como fazer a combinação necessária de botões.

      Passo 1. Já no jogo, acelere com seu veículo ao pressionar o botão RT, localizado na parte de cima do controle;

      Passo 2. Enquanto estiver acelerando, dê pequenos toques no botão LT, para frear;

      Passo 3. Mantenha o esquema de pressionar estes dois botões alternadamente para manter o drift e, claro, controle o manuseio do carro com o analógico direcional.

      Não há muito segredo para o drift básico, além destas combinações de botões. No fim, o que realmente importa para fazer a manobra é a sua habilidade. Por isso, treino e costume são fundamentais.

      De qualquer forma, vale ressaltar que o ideal é que o drift seja realizado em curvas, já que são nelas que costumamos frear para avançar sem bater. Com a técnica, é possível perder pouca aceleração e não cair posições em uma prova, por exemplo.

      Outra boa dica é trocar de marcha manualmente, e não automaticamente, como o game sugere. Isso torna o aprendizado mais complicado, mas dá maior controle ao usuário do carro, já que é possível manter o veículo estável por mais tempo. Para mais, não deixe de treinar em várias possibilidades de terreno, seja no asfalto, grama ou areia, pois o drift sempre vai ser diferente em cada um deles.

      Veículos leves e sem grandes complicações técnicas são os melhores para começar a aprender a fazer Drift. Não tente treinar com carros muito pesados, grandes e altos, ainda que isso não seja proibido. Assim, confira, abaixo, quais os carros mais adequados para treinar a manobra.
    ...
    },
    {
      ...
      conteudo: `
      Risk of Rain 2 traz a sequência do aclamando game independente Risk of Rain com uma inesperada transição para o mundo dos jogos 3D. O título foi lançado recentemente no serviço de "Acesso Antecipado" da loja digital Steam e por ora não conta com uma data de lançamento da versão completa. O jogo se tornou um sucesso com mais de 30 mil jogadores nos últimos 30 dias.

      Confira como baixar e dar seus primeiros passos através desse tutorial feito na versão inicial de Risk of Rain 2, build 3678136, jogada no sistema operacional Windows 10.

      O serviço "acesso antecipado" da loja digital Steam permite jogar um game antes que ele esteja totalmente finalizado, muitas vezes ainda em seu estado inicial de desenvolvimento. Isso significa que Risk of Rain 2 ainda não conta com todas as funções que o jogo completo promete trazer e pode oferecer problemas técnicos como bugs e crashes (travamentos).

      Em compensação o jogador ganha a chance de experimentar o game com antecedência e participar da comunidade do jogo no Steam onde pode dar sugestões e reportar bugs aos desenvolvedores.

      Passo 1: Abra o site da loja digital Steam ao clicar neste link.

      Passo 2: Clique na caixa de texto que diz "Buscar na loja", digite o nome do game "Risk of Rain 2" e clique na página do jogo.

      Passo 3: Um pouco abaixo das imagens do jogo e do aviso de "Jogo com acesso antecipado" clique em "+ Carrinho" para comprá-lo.

      Passo 4: Abra seu carrinho e finalize a compra, para sua conta ou como presente para um amigo, com um dos métodos de pagamento oferecidos.

      Passo 5: Pronto! Agora basta abrir o cliente do Steam e clicar em Instalar para baixar o jogo.

      Risk of Rain 2 é um game do tipo "Rogue" no qual o jogador começa sem nada, constrói seu arsenal através de sua jornada e se morrer precisa começar tudo de novo do zero. Durante as partidas monstros irão surgir incessantemente e sempre que o jogador os mata ganha dinheiro e pontos de experiência. Dinheiro é usado para abrir baús e ganhar itens, enquanto experiência faz o jogador subir de nível e aumentar seus atributos.

      Em todas as fases o jogador precisa encontrar um teletransportador que o levará para a próxima fase e quanto mais tempo demora para encontrá-lo, mais difícil o jogo se torna. Ao encontrar e ativar o portal ele começará a carregar energia e invocará um "chefão" para lutar contra o jogador. Para seguir adiante é preciso derrotar o chefão e ficar perto do portal até que ele chegue a 100%. Todo o dinheiro que não for gasto nessa fase é convertido em experiência.

      Nos mapas do jogo é possível encontrar várias oportunidades para se fortalecer, todas com uma característica cor azul. Os baús são caixas que custam uma certa quantia de dinheiro para serem abertos e dão um item ao jogador, quanto mais difícil o jogo fica, mais caros os baús. Os drones são robôs que podem lutar pelo jogador se forem consertados com dinheiro. Por último, os terminais são como lojas nas quais três itens estão à mostra. O jogador pode "comprar" um deles, mas os outros são descartados.

      Espalhados pelo mapa às vezes estão pequenos altares para realizar oferendas chamados "Shrines". O Shrine of Combat invoca inimigos para o jogador combater. Shrine of Blood sacrifica parte da sua energia em troca de dinheiro. Shrine of Chance é como uma aposta, uma oferenda em dinheiro em troca de receber ou não um item, porém na maioria das vezes o jogador acaba sem recompensa. O Shrine of the Mountain duplica o "chefão" e em compensação dobra sua recompensa.

      Inicialmente só é possível escolher o Commando como personagem, um soldado equilibrado e eficiente, sem características excepcionais. Ele conta com um ataque básico chamado Double Tap no qual atira com suas duas pistolas e um ataque mais forte chamado Phase Round que causa dano a todos os inimigos que estiverem em sua linha de fogo.

      O Commando também possui um ataque chamado Suppressive Fire no qual dispara seis vezes rapidamente e pode causar "Stun" (tonteio) nos inimigos. Por último ele tem a técnica Tactical Dive, um movimento rápido para desviar de ataques inimigos. Exceto pela Double Tap, todas as técnicas têm um período de espera após serem usadas uma vez.

      É possível desbloquear mais personagens ao completar certas tarefas e desvendar segredos do game, porém isso depende do jogador explorar mais os mapas e também ter um pouco de sorte. Na atual versão do jogo há outros cinco personagens para serem desbloqueados além do Commando.

      A melhor parte de Risk of Rain 2 é que ele pode ser jogado em multiplayer com outras três pessoas. Ao selecionar a opção "Enter QuickPlay" o game irá procurar automaticamente por outros participantes desconhecidos para se aventurar com você. Em "Start Private Game" e "Invite Friends" é possível convidar amigos da sua lista do Steam para entrar na partida.
      `,
    ...
    },
    {
      ...
      conteudo: `
      Metal Gear Rising: Revengeance é o primeiro grande jogo do ano, mas desta vez em forma de relançamento nos computadores. Em semana fraca, no ritmo lento do início de 2014, os jogadores podem contar ainda com algumas novidades no PlayStation 4 e Nintendo 3DS, enquanto outras plataformas esquentam os motores para os meses que virão. Confira os destaques:

      Metal Gear Rising: Revengeance é o mais novo capítulo na famosa série de espionagem que deixa de lado o fator de furtividade para se focar na ação. No controle de Raiden o jogador se depara com um verdadeiro exemplar do gênero “hack and slash”, onde a principal tarefa é avançar pelas fases e vencer os inimigos enquanto curtimos a história.

      Por falar em história, ela se passa após os eventos de Metal Gear Solid 4. Raiden agora é um ninja cibernético com ainda mais habilidades e precisa cumprir uma missão difícil, onde vai encarar inimigos muito maiores e mais poderosos do que ele. Para isso o herói conta com sua fiel espada e habilidades dignas de um verdadeiro ninja.
      `,
